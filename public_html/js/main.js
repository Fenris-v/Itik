function getHref() {
    return window.location.href.substring(8);
}

var href = getHref(),
    refer = document.referrer,
    utmFields = document.getElementsByClassName('utmInputField');

for (var ff = 0; ff < utmFields.length; ff++) {
    utmFields[ff].value = href;
}
...
$(function() {
    ...
    if ($('.bigphoto__list').length) {

        $('.bigphoto__list').slick({
            dots: true,
            slidesToShow: 1,
            slidesToScroll: 1,
            fade: true,
            infinite: true,
            asNavFor: '.slickBottom',
            arrows: true,
            responsive: [
                {
                    breakpoint: 768,
    ...
    if ($('.slickBottom').length) {

        $('.slickBottom').slick({
            slidesToShow: 5,
            slidesToScroll: 1,
            asNavFor: '.bigphoto__list',
            dots: false,
            infinite: true,
            focusOnSelect: true,
            arrows: false
    ...
    if ($('.bigphoto__list_inner').length) {


        $('.bigphoto__list_inner').slick({
            dots: true,
            slidesToShow: 1,
            slidesToScroll: 1,
            arrows: false,
    ...
    var owlSecondBlock = $('.owlSecondBlock');

    owlSecondBlock.owlCarousel({
        margin: 10,
        nav: true,
        loop: true,
        navText: '',
    ...
    $('#telephone__form').validate({
        ...
        messages: {
            ...
            'data[new][nomer_telefona]': {
                requiredphone: 'Это поле должно быть заполнено',
                minlenghtphone: 'Номер телефона содержит более 9 символов',
                checkMask: 'Осталось совсем чуть-чуть :)'
            },
            'personal[]': {
        ...
        submitHandler: function (form) {
            var hfield = $('.custom_form_row input').val();
            if (hfield === ''){
                $('.custom_form_row input').val('toomanytextformybot11223344');
            }
            form.submit();
        }
    });
    ...
    $('[name="data[new][nomer_telefona]"]').mask("+7(999) 999-99-99? 9", {autoclear: false});
    $('[name="data[new][telefon]"]').mask("+7(999) 999-99-99? 9", {autoclear: false});
    ...
    /*
       ...
       $(window).load(function() {
           ...
           $('#screenShots__previev').flexslider({
               animation: "slide",
               controlNav: false,
               animationLoop: false,
               slideshow: false,
               ...
               prevText: " ",
               nextText: " ",
               asNavFor: '#screenShots__bigphoto'
           });

           $('#screenShots__bigphoto').flexslider({
               animation: "slide",
               controlNav: true,
               animationLoop: false,
               slideshow: true,
...
$(document).ready(function(){
    ...
    $('.doc-item__morebtn').on('click', function (e) {
        console.log($(this).data('link'));
        $('.new_ssylka_na_dokument').val($(this).data('link'));
    })
